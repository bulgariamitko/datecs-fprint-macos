...
begin
	try
		...
		On E:exception do
			raise E.Create('Exception in "FF" metod : '+E.Message);
	end;
end;
...
begin
	try
		...
		On E:exception do
			raise E.Create('Exception in "GG" metod : '+E.Message);
	end;
end;
...
begin
	try
		...
		On E:exception do
			raise E.Create('Exception in "HH" metod : '+E.Message);
	end;
end;
...
begin
	try
		...
		On E:exception do
			raise E.Create('Exception in "II" metod : '+E.Message);
	end;
end;
...
begin
	try
		...
		On E:Exception do
			raise E.Create('Exception in "Transform" metod : '+E.Message);
     end;
end;
...
begin
	try
		...
		On E:Exception do
			raise E.Create('Exception in "MD5Init" metod : '+E.Message);
...
begin
	...
	Except
		On E:Exception do
			raise Exception.Create('Exception in "MD5Update" metod : '+E.Message);
     end;
end;
...
begin
	try
		...
		On E:Exception do
			raise exception.create('Exception in "MD5Final" metod : '+E.Message);
	end;
end;
...
begin
	try
		...
		On E:Exception do
			raise exception.create('Exception in "MD5String" metod : '+E.Message);
